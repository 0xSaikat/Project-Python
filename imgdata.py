...
# Get a list of all the files in the Pictures directory.
files = os.listdir()

# Check if you have any files in the ./Pictures folder.
if len(files) == 0:
    print("You don't have have files in the ./Pictures folder.")
    exit()
